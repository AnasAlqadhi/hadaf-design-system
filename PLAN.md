...
| 2026-06-17 | **Phase 3 SEO live & verified** (sitemap.xml/robots.txt → 200; 35 on-site article pages). **World Cup 2026 feature added:** homepage `WorldCupBanner` (stadium hero → /wc), homepage "مونديال 2026" spotlight + World Cup page now both pull live World Cup articles from the feed. Auto-updating, no manual edits. |
